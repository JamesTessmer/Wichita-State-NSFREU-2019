...
class GENEt(object):
    ...
    def __init__(self, iterator,
        ...
        if self.mode == 'sg':
            ...
            num_groups = len(num_units) -1  #remove -1 later
            print(num_groups)
            print("LOOK HERE FOR NUM GROUPS")
    ...
    def resnet_block(self, input, region_size, conv_filter_shape, name):
        ...
        if change_input_dim:
            input = tf.nn.pool(input, [2, 1], strides=[2, 1], pooling_type='AVG', padding='VALID')
